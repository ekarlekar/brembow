...
class SimulateCages(gp.BatchFilter):
    ...
    segmentation corresponding to the raw array. Renders a random type of cage with
    a random density within each segment.
        ...
        Args:
            ...
            density_range(tuple of floats): The minimum and maximum density to uniformly choose from.
    ...
    def __init__(
        ...
        for id_element in id_list:
            ...
            self.densities[id_element] = random.uniform(self.min_density, self.max_density)
    ...
    def process(self, batch, request):
        ...
        volume = simulate_cages(Volume(data, self.res), self.seg, self.cage_ids, self.densities, self.psf)
...
source = gp.ZarrSource(
    '/Users/ekarlekar/Documents/Funke/data/cropped_sample_A.zarr',  # the zarr container
    {tiny_raw: 'tiny_raw'} ,  # which dataset to associate to the array key
    {tiny_raw: gp.ArraySpec(interpolatable = True, voxel_size = resolution)}  # meta-information
)
print("SOURCE")
print(source)
...
pipeline = (source + normalize + SimulateCages(tiny_raw, seg, resolution, psf, (min_density, max_density), [cage1]))

print("PIPELINE")
print(pipeline)

request = gp.BatchRequest()
request[tiny_raw] = gp.Roi((0,0,0), (400,4000,4000)) # how to change this to be specific to segment ID? 
